...
pub fn api_security_assessment() -> Playbook {
    Playbook::new("api-security-assessment", "API Security Assessment")
        ...
        .with_objective("Identify API-specific vulnerabilities including BOLA, injection, and authorization flaws")
        .for_target(TargetType::Api)
        .for_target(TargetType::WebApp)
        .for_os(TargetOS::Any)
        .with_risk(RiskLevel::Medium)
        ...
        .add_precondition(PreCondition::new("API documentation or schema available (preferred)"))
        // Endpoint Discovery
        .add_step(
        ...
        // Mass Assignment
        .add_step(
            PlaybookStep::new(5, PlaybookPhase::PrivilegeEscalation, "Mass Assignment Test")
        ...
        .add_failed_control(
            FailedControl::new("API Authorization", "Missing or weak object-level authorization")
