...
mod tests {
  ...
  fn test_memory_add_finding() {
    ...
    let finding = Finding::new(FindingType::Host, "test.com".to_string()).with_source("recon_0");
  ...
  fn test_graph_update_queuing() {
    ...
    let finding =
      Finding::new(FindingType::Service, "ssh:22".to_string()).with_related("other_finding_id");
  ...
  fn test_graph_update_flush() {
    ...
    // Add a host finding
    let host = Finding::new(FindingType::Host, "192.168.1.1".to_string()).with_source("scanner");
    ...
    let host = Finding::new(FindingType::Host, "192.168.1.1".to_string()).with_source("scanner");
    memory.add_finding(host);
    let service = Finding::new(FindingType::Service, "SSH:22".to_string()).with_source("scanner");
    memory.add_finding(service);
