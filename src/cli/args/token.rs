...
mod tests {
  ...
  fn test_mixed() {
    ...
    assert_eq!(
      tokens,
      vec![
        Token::Positional(s("dns")),
        Token::Positional(s("record")),
        Token::Positional(s("lookup")),
        Token::Positional(s("example.com")),
        Token::LongFlag {
          name: s("type"),
          value: None,
        },
        Token::Positional(s("MX")),
        Token::ShortFlag {
          name: 'v',
          value: None,
        },
  ...
  fn test_realistic_command() {
    // rb network ports scan 192.168.1.1 --preset common --threads 500 -v
    let tokens = tokenize(&args(&[
      "network",
      "ports",
      "scan",
    ...
    assert_eq!(
      tokens,
      vec![
        Token::Positional(s("network")),
        Token::Positional(s("ports")),
        Token::Positional(s("scan")),
        Token::Positional(s("192.168.1.1")),
        Token::LongFlag {
          name: s("preset"),
          value: None,
        },
        Token::Positional(s("common")),
        Token::LongFlag {
          name: s("threads"),
          value: Some(s("500")),
        },
