...
pub use algorithms::{
    cmd_centrality, cmd_communities, cmd_components, cmd_cycles, cmd_pagerank, cmd_paths,
    find_paths,
};
...
pub use operations::{
    cmd_export, cmd_import, cmd_insights, cmd_query, cmd_report, cmd_rql_help, cmd_stats,
    cmd_summary,
};
pub use viz::{
...
impl Command for IntelGraphCommand {
    ...
    fn flags(&self) -> Vec<Flag> {
        vec![
            ...
            Flag::new("report-output", "Report output file path")
                .with_default("intelligence-report.md"),
