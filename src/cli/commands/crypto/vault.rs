  ...
  fn flags(&self) -> Vec<crate::cli::commands::Flag> {
    vec![
      crate::cli::commands::Flag::new("output", "Output file path")
        .with_short('o')
        .with_arg("FILE"),
      crate::cli::commands::Flag::new("format", "Output format (text, json)").with_default("text"),
      crate::cli::commands::Flag::new("password", "Password (omit for secure prompt)")
        .with_short('p')
        .with_arg("PASS"),
      crate::cli::commands::Flag::new("force", "Overwrite existing output file").with_short('f'),
    ]
  }
