...
use crate::storage::wal::{
  CheckpointError, CheckpointMode, CheckpointResult, Checkpointer, Transaction, TransactionManager,
  TxError,
};
...
impl Database {
  ...
  pub fn open_with_config<P: AsRef<Path>>(
    ...
    let tx_manager =
      Arc::new(TransactionManager::new(Arc::clone(&pager), &wal_path).map_err(DatabaseError::Io)?);
