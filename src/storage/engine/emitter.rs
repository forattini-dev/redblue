...
impl GraphEmitter {
  ...
  pub fn emit_service(&self, host_ip: &str, port: u16, service_name: &str, version: Option<&str>) {
    // Ensure host exists
  ...
  pub fn emit_credential(&self, username: &str, password: Option<&str>, source_host: Option<&str>) {
  ...
  pub fn emit_credential_access(&self, username: &str, password: Option<&str>, target_host: &str) {
