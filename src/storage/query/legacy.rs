//! Legacy Query Interface for RedDB
//!
//! Simple key-value query interface for backward compatibility.
//! For new code, prefer using the filter/sort/executor modules.
//!
//! NOTE: This module uses the legacy engine (engine_legacy) which is a
//! simple append-only log. For the new page-based B-tree engine, use
//! `crate::storage::engine::Database` instead.

use crate::storage::engine_legacy::RedDB;
use std::io;
