...
pub use unified_adapter::{
  ...
  MultiModalQuery, NodePattern, QueryCondition, QueryValue, UnifiedQueryResult, UnifiedQueryStats,
  UnifiedStoreAdapter,
};
...
impl QueryAnalyzer {
  pub fn new() -> Self {
    Self {
      ...
      enum_keywords: vec![
        "all", "list", "find", "show", "get", "which", "what", "where", "filter", "having", "with",
      ],
    }
  }
  ...
  fn extract_keywords(&self, query: &str) -> Vec<String> {
    ...
    let stop_words = [
      ...
      "of", "in", "for", "on", "with", "at", "by", "from", "as", "into", "about", "i", "me", "my",
      "we", "our",
    ];
