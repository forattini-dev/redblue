...
use super::serializer::{Record, Serializer};
...
mod tests {
    ...
    fn test_basic_operations() {
        ...
        // Insert
        db.insert(b"domain:example.com".to_vec(), b"192.168.1.1".to_vec())
            .unwrap();
        db.insert(b"domain:google.com".to_vec(), b"8.8.8.8".to_vec())
            .unwrap();
    ...
    fn test_performance_1m_records() {
        ...
        for i in 0..1_000_000 {
            ...
            db.insert(key.as_bytes().to_vec(), b"open".to_vec())
                .unwrap();
