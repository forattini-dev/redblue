  ...
  fn analyze_issues(
    ...
    if is_expired {
      issues.push(CertIssue {
        ...
        description: "The certificate is no longer valid and browsers will show security warnings"
          .to_string(),
      });
    }
    ...
    if is_expiring_soon {
      issues.push(CertIssue {
        ...
        description: "Certificate should be renewed soon to avoid service disruption".to_string(),
      });
    }
    ...
    if is_self_signed {
      issues.push(CertIssue {
        ...
        description: "Self-signed certificates are not trusted by browsers and clients".to_string(),
      });
    }
