...
impl ToolCategory {
  ...
  pub fn from_tool_name(name: &str) -> Self {
    match name {
      // Discovery
      "rb.list-domains" | "rb.list-resources" | "rb.describe-command" => ToolCategory::Discovery,
      ...
      // Web
      "rb.web.crawl" | "rb.web.scrape" | "rb.html.select" | "rb.web.links" | "rb.web.tables" => {
        ToolCategory::Web
      }
      ...
      // Intel
      "rb.intel.mitre.map" | "rb.intel.mitre.layer" | "rb.intel.ioc.extract" => ToolCategory::Intel,
...
impl CategoryPreset {
  ...
  pub fn description(&self) -> &'static str {
    match self {
      ...
      CategoryPreset::BlueTeam => "Blue team focus: network, recon, vuln, intel, auto (36 tools)",
