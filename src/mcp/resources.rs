...
impl ResourceRegistry {
  ...
  fn gen_capabilities(&self) -> String {
    r#"{"domains":["network","dns","web","recon","intel","exploit","memory","database"]}"#.into()
  }
  ...
  fn gen_cpe_dictionary(&self) -> String {
    r#"{"version":"2.3","entries":65,"categories":["webservers","frameworks","cms","databases"]}"#
      .into()
  }
  ...
  fn gen_db_partitions(&self) -> String {
    r#"{"partitions":[],"tables":["ports","subdomains","dns","tls","http","whois","vulns"]}"#.into()
  }
  ...
  fn gen_wordlist_index(&self) -> String {
    r#"{"wordlists":["common","directories","api-endpoints","passwords-top1000","vhosts"]}"#.into()
  }
