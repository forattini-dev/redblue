...
pub fn register_network_tools() -> Vec<ToolDefinition<McpServer>> {
  vec![
    ToolDefinition {
      ...
      description:
        "Scan target for open ports. Supports common, web, full, or custom port specifications.",
      fields: &[
        ToolField {
          name: "target",
          field_type: "string",
        ...
        ToolField {
          ...
          field_type: "string",
          description:
            "Ports to scan: 'common', 'web', 'full', or custom (e.g., '22,80,443' or '1-1000').",
          required: false,
        },
        ToolField {
          name: "timeout",
    ...
    ToolDefinition {
      ...
      fields: &[
        ...
        ToolField {
          ...
          field_type: "string",
          description:
            "Shard specification for distributed scanning (e.g., '1/4' for first of 4 shards).",
          required: false,
        },
        ToolField {
          name: "resume",
...
fn tool_network_scan_fast(_server: &mut McpServer, args: &JsonValue) -> Result<ToolResult, String> {
  ...
  let scan_range = ScanRange::from_cidr(cidr, ports).map_err(|e| format!("Invalid CIDR: {}", e))?;
