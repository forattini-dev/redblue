...
impl Stream {
  ...
  pub fn transition(&mut self, event: StreamEvent) -> Result<(), String> {
    let new_state = match (self.state, event) {
      ...
      (StreamState::Idle, StreamEvent::ReceiveHeadersEndStream) => StreamState::HalfClosedLocal,
      ...
      (StreamState::HalfClosedRemote, StreamEvent::ReceiveHeaders) => StreamState::HalfClosedRemote,
      (StreamState::HalfClosedRemote, StreamEvent::ReceiveHeadersEndStream) => StreamState::Closed,
