...
use crate::modules::web::strategies::{
  ...
  DrupalScanner, GhostScanResult, GhostScanner, JoomlaScanResult, JoomlaScanner, LaravelScanResult,
  LaravelScanner, StrapiScanResult, StrapiScanner, WPScanResult, WPScanner,
};
