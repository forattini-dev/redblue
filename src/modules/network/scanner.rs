...
impl PortScanner {
  ...
  pub fn get_common_ports() -> Vec<u16> {
    vec![
      ...
      // Web & apps
      3000, 3128, 3268, 3306, 3389, 3690, 4369, 4443, 5000, 5005, 5060, 5222, 5432, 5601, 5672,
      5900, 5984, 5985, 6379, 6443, 6667, // Management & monitoring
      7001, 7474, 7687, 8000, 8008, 8009, 8080, 8081, 8088, 8123, 8139, 8140, 8200, 8443, 8500,
      8834, 8888, 9000, 9042, 9090, 9092, 9100, 9200, 9300, 9418, // Infrastructure
...
impl AdvancedScanner {
  ...
  pub fn get_common_udp_ports() -> Vec<u16> {
    vec![
      53, 67, 68, 69, 88, 111, 123, 137, 138, 161, 162, 177, 389, 464, 500, 514, 520, 623, 636,
      853, 1194, 1434, 1701, 1812, 1813, 1900, 2049, 3478, 4500, 5060, 5353, 5683, 6343, 8125,
    ]
  }
}
