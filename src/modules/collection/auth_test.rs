...
use crate::modules::collection::creds::{DEFAULTS, DefaultCredential, DefaultCreds};
...
impl CredentialTester {
    ...
    pub fn test_defaults(&mut self, target_url: &str, form: &LoginForm, app_hint: Option<&str>) -> Vec<&'static DefaultCredential> {
    ...
    fn try_login(&mut self, base_url: &str, form: &LoginForm, cred: &DefaultCredential) -> bool {
        ...
        // Add User-Agent
        request.headers.insert("User-Agent".to_string(), "redblue/1.0".to_string());
