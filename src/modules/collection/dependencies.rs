...
impl DependencyScanner {
  ...
  fn parse_package_json(&self, content: &str, file_path: &str) -> Result<Vec<Dependency>, String> {
    ...
    db.insert(
      ...
      (
        ...
        Vulnerability {
          ...
          description: "Lodash versions before 4.17.21 are vulnerable to command injection"
            .to_string(),
    ...
    db.insert(
      ...
      (
        ...
        Vulnerability {
          ...
          description: "Express versions before 4.17.3 are vulnerable to open redirect".to_string(),
    ...
    db.insert(
      ...
      (
        ...
        Vulnerability {
          ...
          description: "Django versions before 3.2.13 are vulnerable to SQL injection".to_string(),
    ...
    db.insert(
      ...
      (
        ...
        Vulnerability {
          ...
          description: "Requests versions before 2.31.0 have proxy validation issues".to_string(),
