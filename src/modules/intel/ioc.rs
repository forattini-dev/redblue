...
mod tests {
  ...
  fn test_extract_emails_from_text() {
    let emails =
      IocExtractor::extract_emails_from_text("Contact us at admin@example.com or support@test.org");
  ...
  fn test_extract_domains_from_csp() {
    let csp =
      "default-src 'self'; script-src https://cdn.example.com https://api.test.org; img-src *";
