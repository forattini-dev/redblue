...
mod tests {
  ...
  fn test_aggregated_results() {
    ...
    result1.add_finding(
      Finding::new(FindingType::Vulnerability, "Test Vuln").with_severity(FindingSeverity::High),
    );
  ...
  fn test_high_priority_findings() {
    ...
    result.add_finding(
      Finding::new(FindingType::Vulnerability, "High Issue").with_severity(FindingSeverity::High),
    );
