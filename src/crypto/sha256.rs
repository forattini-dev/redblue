...
///
/// This is a cryptographically secure hash function
/// implemented using only Rust std library
...
impl Sha256 {
    ...
    pub fn finalize(mut self) -> [u8; 32] {
        // Padding
        let msg_len_bits = self.length * 8;
        self.buffer.push(0x80);

        // Pad with zeros until we have 56 bytes (448 bits) in current block
